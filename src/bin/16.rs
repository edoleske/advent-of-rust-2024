...
mod tests {
    ...
    fn test_part_two() {
        ...
        let result2 = part_two(&advent_of_code::template::read_file_part(
            "examples", DAY, 0,
        ));
        assert_eq!(result2, Some(64));
    }
}
